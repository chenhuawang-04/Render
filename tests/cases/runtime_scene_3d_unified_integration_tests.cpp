...
struct UnifiedScene3DRecorder final {
    ...
    void ConfigureTargets() {
        scene_targets.ConfigureSceneRenderer(geometry_renderer, vr::render::SceneRenderPassRole::first);
        scene_targets.ConfigureSceneRenderer(surface_renderer, vr::render::SceneRenderPassRole::middle);
        scene_targets.ConfigureSceneRenderer(text_renderer, vr::render::SceneRenderPassRole::last);
