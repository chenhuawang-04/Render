...
> 统计 (当前分支 `develop`, commit `ed75b15`): 约 195 个头文件, 57 个源文件, 33 个着色器 + 5 个 GLSL 头文件, 13 个示例, 73 个测试文件, 20 个基准文件, 17 个文档, 8 个脚本, 4 个工具, 1 个 CMake Presets
...
| `geometry_renderer_3d.hpp` | `GeometryRenderer3D`, `GeometryRenderer3DCreateInfo`, `GeometryRenderer3DStats` | 3D 几何渲染器。GPU 实例化绘制 (instanced draw)、PBR 材质绑定 (bindless + Appearance SampledSurface)、管线状态。集成 Appearance 和 Shadow 支持。 |
