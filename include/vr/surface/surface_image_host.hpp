...
public:
    ...
    [[nodiscard]] const ImageRecord* FindImage(SurfaceImageId image_id_) const noexcept;
    [[nodiscard]] render::BindlessSlot ResolveBindlessImageSlot(SurfaceImageId image_id_) const noexcept;
...
private:
    [[nodiscard]] std::size_t LowerBoundImageIndex(SurfaceImageId image_id_) const noexcept;
