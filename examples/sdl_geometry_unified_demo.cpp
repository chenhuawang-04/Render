...
int main() {
    ...
    try {
        ...
        recorder.renderer_3d.SetHosts(&geometry_resource_host, &geometry_upload_host);
        recorder.renderer_3d.SetMaterialHosts(&geometry_material_host, &geometry_image_host);
        recorder.renderer_3d.SetSceneData(geometry_3d_components.data(),
        ...
        recorder.renderer_2d.SetHost(&geometry_upload_host);
