...
[[nodiscard]] vr::render::SceneRecorder3DCreateInfo BuildTextSceneRecorderCreateInfo() noexcept {
    vr::render::SceneRecorder3DCreateInfo create_info{};
    create_info.scene_target.color_debug_name = "Text3DSceneColor";
    create_info.scene_target.depth_debug_name = "Text3DSceneDepth";
...
int main(int argc_,
    ...
    try {
        ...
        recorder.Initialize(BuildTextSceneRecorderCreateInfo());
