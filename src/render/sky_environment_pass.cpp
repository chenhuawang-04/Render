...
[[nodiscard]] bool SupportsDrawMode(scene::SkyEnvironmentMode mode_) noexcept {
...
void SkyEnvironmentPass::PrepareFrame(const SkyEnvironmentPassPrepareView& prepare_view_,
                                      const scene::SkyEnvironmentRenderState&,
...
void SkyEnvironmentPass::Record(const FrameRecordContext& record_context_,
    ...
    if (!SupportsDrawMode(state_.mode)) {
...
void SkyEnvironmentPass::EnsurePipelineObjects(VulkanContext& context_,
